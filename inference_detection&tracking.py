...
def main():
    ...
    parser.add_argument('--modality', type=str, choices=['IR', 'RGB'], default='RGB')
    # modality thresholds
    ...
    rgb_output = os.path.join(args.output_dir, f"{args.team_name}_{args.modality}_submission.csv")
